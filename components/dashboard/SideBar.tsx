...
export default function SideBar() {
  ...
  return (
    <div className="flex flex-col h-full p-4 space-y-3 bg-white shadow text-lg">
      {/* New Post */}
      ...
      <div className="flex flex-col gap-2 flex-1 text-lg">
        <Link href="/dashboard" className="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-200 transition-colors">
      ...
      <button 
        ...
        className="flex items-center gap-2 px-3 py-2 rounded text-red-500 hover:bg-gray-100  active:text-blue-600 transition-colors mt-auto cursor-pointer">
